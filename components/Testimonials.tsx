  ...
  return (
    <section>
      <div className='py-20 w-[80%] m-auto flex flex-col justify-center items-center gap-10 '>
        ...
        <p className='text-xl md:w-[80%] text-center text-black/60'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi esse molestias magni, quis cupiditate distinctio repellendus, quidem ea nesciunt vero, repudiandae at corrupti suscipit amet minima. Qui consequuntur esse perspiciatis?
