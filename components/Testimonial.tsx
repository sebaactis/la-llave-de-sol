...
const Testimonial = ({ reverse }: { reverse: Boolean }) => {
    return (
        <div className={`flex ${reverse ? "md:flex-row-reverse" : "md:flex-row"} flex-col justify-center items-center md:items-start gap-14 md:gap-20`}>
            <Image alt="imagen testimonio" className='rounded-md w-[23rem] md:w-[30rem] 2xl:w-[35rem]' src={img} />
