    ...
    <section className="container mx-auto px-6 py-24 mt-20" id="benefits">
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-4">
          ...
          <BenefitCard
            description="Aprenderas a cocinar sin azúcar y sin glúten. Fácil y rápido.
                    Recetas prácticas y simples que podrás hacer en 5 minutos para resolver tu día de manera espectacular."
            icon={<HeartPulse className="w-8 h-8 text-white" />}
            title="Medicina en tu cocina"
          />
          <BenefitCard
            description="Descubrirás como el azúcar impacta en tu cuerpo y en tu mente.
            ...
            title="Somos los que comemos"
          />
          <BenefitCard
            description="Conectarás con lo nos nutre DENTRO y FUERA de tu plato.
                    A través de ejercicios prácticos, desbloquea hábitos y emociones que hoy te alejan del bienestar. "
